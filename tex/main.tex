...
\begin{document}
    \begin{center}
        ...
        \Huge
        \textbf{Solving a generalisation of tic-tac-toe or $k$-in-a-row game on finite and infinite $\{m, n\}$ tilings of 2D space}
    ...
    \section{Introduction}
        ...
        \subsection{Notation}
            ...
            \subsubsection{$mnk$-notation}

                To denote a game variant played on a $\{m, n\}$ tiling with the winning objective of getting $k$ in a row, we will use the notation $\{m, n\}^k$. For example, the classical tic-tac-toe game is denoted as $\{4, 4\}^3$.
        ...
        \subsection{Maker-Breaker games}
            ...
            \subsubsection{Insights into Maker-Maker games}
                If a $k$-game is a Breaker win in the Maker-Breaker version, we know that the original Maker-Maker version is a draw.
                Conversely if a $k$-game is a Maker win in the Maker-Breaker version, we cannot tell anything about the original Maker-Maker variant.
                Therefore to prove Maker wins, we have to show them in the Maker-Maker version.
    ...
    \section{Tiling spaces}
        ...
        \noindent
        \begin{footnotesize}
        \begin{tabular}{|c||C{0.65in}|C{0.65in}|C{0.65in}|C{0.65in}|C{0.65in}|C{0.65in}|C{0.65in}|C{0.65in}|}
            \hline
            \textbf{m \textbackslash n} & \textbf{2} & \textbf{3} & \textbf{4} & \textbf{5} & \textbf{6} & \textbf{7} & \textbf{8} & \textbf{$\infty$} \\ \hline \hline

            \textbf{2} & 
            \makecell{$\{2,2\}$ \\ Spherical} & 
            \makecell{$\{2,3\}$ \\ Spherical} & 
            \makecell{$\{2,4\}$ \\ Spherical} & 
            \makecell{$\{2,5\}$ \\ Spherical} & 
            \makecell{$\{2,6\}$ \\ Spherical} & 
            \makecell{$\{2,7\}$ \\ Spherical} & 
            \makecell{$\{2,8\}$ \\ Spherical} & 
            \makecell{$\{2,\infty\}$ \\ Euclidean} \\ \hline

            \textbf{3} & 
            \makecell{$\{3,2\}$ \\ Spherical} & 
            \makecell{$\{3,3\}$ \\ Platonic} & 
            \makecell{$\{3,4\}$ \\ Platonic} & 
            \makecell{$\{3,5\}$ \\ Platonic} & 
            \makecell{$\{3,6\}$ \\ Euclidean} & 
            \makecell{$\{3,7\}$ \\ Hyperbolic} & 
            \makecell{$\{3,8\}$ \\ Hyperbolic} & 
            \makecell{$\{3,\infty\}$ \\ Paracompact} \\ \hline

            \textbf{4} & 
            \makecell{$\{4,2\}$ \\ Spherical} & 
            \makecell{$\{4,3\}$ \\ Platonic} & 
            \makecell{$\{4,4\}$ \\ Euclidean} & 
            \makecell{$\{4,5\}$ \\ Hyperbolic} & 
            \makecell{$\{4,6\}$ \\ Hyperbolic} & 
            \makecell{$\{4,7\}$ \\ Hyperbolic} & 
            \makecell{$\{4,8\}$ \\ Hyperbolic} & 
            \makecell{$\{4,\infty\}$ \\ Paracompact} \\ \hline

            \textbf{5} & 
            \makecell{$\{5,2\}$ \\ Spherical} & 
            \makecell{$\{5,3\}$ \\ Platonic} & 
            \makecell{$\{5,4\}$ \\ Hyperbolic} & 
            \makecell{$\{5,5\}$ \\ Hyperbolic} & 
            \makecell{$\{5,6\}$ \\ Hyperbolic} & 
            \makecell{$\{5,7\}$ \\ Hyperbolic} & 
            \makecell{$\{5,8\}$ \\ Hyperbolic} & 
            \makecell{$\{5,\infty\}$ \\ Paracompact} \\ \hline

            \textbf{6} & 
            \makecell{$\{6,2\}$ \\ Spherical} & 
            \makecell{$\{6,3\}$ \\ Euclidean} & 
            \makecell{$\{6,4\}$ \\ Hyperbolic} & 
            \makecell{$\{6,5\}$ \\ Hyperbolic} & 
            \makecell{$\{6,6\}$ \\ Hyperbolic} & 
            \makecell{$\{6,7\}$ \\ Hyperbolic} & 
            \makecell{$\{6,8\}$ \\ Hyperbolic} & 
            \makecell{$\{6,\infty\}$ \\ Paracompact} \\ \hline

            \textbf{7} & 
            \makecell{$\{7,2\}$ \\ Spherical} & 
            \makecell{$\{7,3\}$ \\ Hyperbolic} & 
            \makecell{$\{7,4\}$ \\ Hyperbolic} & 
            \makecell{$\{7,5\}$ \\ Hyperbolic} & 
            \makecell{$\{7,6\}$ \\ Hyperbolic} & 
            \makecell{$\{7,7\}$ \\ Hyperbolic} & 
            \makecell{$\{7,8\}$ \\ Hyperbolic} & 
            \makecell{$\{7,\infty\}$ \\ Paracompact} \\ \hline

            \textbf{8} & 
            \makecell{$\{8,2\}$ \\ Spherical} & 
            \makecell{$\{8,3\}$ \\ Hyperbolic} & 
            \makecell{$\{8,4\}$ \\ Hyperbolic} & 
            \makecell{$\{8,5\}$ \\ Hyperbolic} & 
            \makecell{$\{8,6\}$ \\ Hyperbolic} & 
            \makecell{$\{8,7\}$ \\ Hyperbolic} & 
            \makecell{$\{8,8\}$ \\ Hyperbolic} & 
            \makecell{$\{8,\infty\}$ \\ Paracompact} \\ \hline

            \textbf{$\infty$} & 
            \makecell{$\{\infty,2\}$ \\ Euclidean} & 
            \makecell{$\{\infty,3\}$ \\ Paracompact} & 
            \makecell{$\{\infty,4\}$ \\ Paracompact} & 
            \makecell{$\{\infty,5\}$ \\ Paracompact} & 
            \makecell{$\{\infty,6\}$ \\ Paracompact} & 
            \makecell{$\{\infty,7\}$ \\ Paracompact} & 
            \makecell{$\{\infty,8\}$ \\ Paracompact} & 
            \makecell{$\{\infty,\infty\}$ \\ Paracompact} \\ \hline
        \end{tabular}
        \end{footnotesize}

        \subsection{Spherical tilings}
            All spherical tilings are finite and therefore do not provide an infinite playing board.
            \subsubsection{The $\{m, 2\}$ tilings}
                The $\{m, 2\}$ tilings consist of only 2 playable polygons, and therefore the game is a trivial draw for $k > 1$ as both of the players occupy exactly one of the polygons.
            \subsubsection{The $\{2, n\}$ tilings}
                Proof is the same as for the $\{2, \infty\}$ tiling.
        \subsection{Platonic tilings}
            Platonic tilings are a subset of phericla tilings that result in the platonic solids. They are the $\{3, 3\}, \{3, 4\}, \{3, 5\}, \{4, 3\}, \{5, 3\}$ tilings and correspond to the tetrahedron, octahedron, icosahedron, cube and dodecahedron respectively.
            Out of these we will only look at $\{4, 3\}$ as all of the other tilings are made of odd-sided polygons and therefore do not satisfy condition \ref{m_condition}.
            \subsubsection{The $\{4, 3\}$ tiling}
                This platonic tiling corresponds to the cube. It is a trivial draw for $k > 3$ as both players alternatively occupy one of the polygons and since there are 6 of them, each player will in the end occupy 3 of the polygons.\\
                For $K \le 2$ it is a win for P1. DUe to symmetry, there is only 1 first move for P1. Then there are 4 adjecent squares, out of which P2 can claim only 1. P1 therefore wins. The game is a draw for $k = 3$ using a pairing strategy as shown in figure \ref{fig:(4, 3)-3}. Using this configuration, both players claim exactly 2 faces along all winning directions, thus making a 3-in-a-row impossible.
                \begin{figure}[ht]
                    \centering
                    \includegraphics[width=0.5\linewidth]{\PATH cube_map_pairing.png}
                    \caption{The drawing pairing strategy for $\{4, 3\}^3$.}
                    \label{fig:(4, 3)-3}
                \end{figure}
        \subsection{Euclidean tilings}
            ...
            \subsubsection{The $\{4, 4\}$ tiling}
                This tiling corresponds to the regular square tiling of the classical tic-tac-toe game. It has been shown to be a draw for $k \ge 8$ by T. G. L. Zetters \cite{guy_selfridge_zetters_1980_s10} and a win for P1 for $k \le 5$ by Victor Allis \cite{Allis1994}.\\
            \subsubsection{The $\{2, \infty\}$ tiling}
                ...
                \begin{figure}[ht]
                    ...
                    \caption{Pairing strategy for $\{2, \infty\}^3$.}
                    \label{fig:{2, infty}}
                \end{figure}\\
            ...
            \subsubsection{The $\{6, 3\}$ tiling}
                ...
                \begin{figure}[ht]
                    \centering
                    \includegraphics[width=0.5\linewidth]{\PATH 6_3_7_zetters_tiling.png}
                    \caption{Pairing strategy for $\{6, 3\}^7$.}
                    \label{fig:{6, 3}-7}
                \end{figure}
                ...
                \begin{figure}[ht]
                    ...
                    \caption{One repeating tile in the $\{6, 3\}^7$ pairing strategy.}
