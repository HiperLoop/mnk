    ...
    \section{Tiling spaces}
        ...
        \subsection{Euclidean tilings}
            ...
            \subsubsection{The $\{4, 4\}$ tiling}
                This tiling corresponds to the regular square tiling of the classical tic-tac-toe game. It has been shown to be a draw for $k \ge 8$ by Zetters \cite{guy_selfridge_zetters_1980_s10} and a win for P1 for $k \le 5$ by Victor ALlis \cite{Allis1994}.\\
