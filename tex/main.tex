...
Thereofre to prove Maker wins, we have to show them in the Maker-Maker version.
...
\subsubsection{The $\{3, 3\}$ tiling}
The $\{3, 3\}$ tiling consists of 4 playable polygons. The game is a trivial draw for $k > 2$ as both of the players occupy exactly two of the polygons. Since all the polygons are adjecent to all the others, it is a win for P1 for $k \le 2$.
\subsubsection{The $\{3, 4\}$ tiling}
The $\{3, 4\}$ tiling consists of 8 playable polygons. The game is a trivial draw for $k > 4$ as both of the players occupy exactly four of the polygons. A simple minimax exploration fo the whole game tree shows that it is a win for P1 for $k \le 4$.
\subsubsection{The $\{3, 5\}$ tiling}
\subsubsection{The $\{4, 3\}$ tiling}
\subsubsection{The $\{5, 3\}$ tiling}
