...
public:
    ...
    double (*move_eval_function)(Tile& target, int playerId, Tiling* tiling, int win_length, int depth, int maxDepth) = nullptr; // Function pointer for the move evaluation function that evalueates the score of the given target tile
